...
The example defaults to Computer::15 -> Computer::16. It is a dry run unless
...
def main() -> None:
    ...
    try:
        ...
        ImpactNavigator(session.page, required("GLPI_URL")).open_impact(
        ...
        persistence = ImpactPersistence(session.page, builder)
        save_result = persistence.save(confirm=confirm)
